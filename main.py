...
def run(args):
    ...
    # TODO: adjust folder
    dataset = datasets.CIFAR10('..\\Exercise01 - ViT and Cross ViT\\train_images', download=True, train=True, transform=transform)
    ...
    # TODO: adjust folder
    testset = datasets.CIFAR10('..\\Exercise01 - ViT and Cross ViT\\test_images', download=True, train=False, transform=transform)
